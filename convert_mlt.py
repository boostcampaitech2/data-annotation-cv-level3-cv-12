...
DST_DATASET_DIR = '/opt/ml/input/data/ICDAR17_Korean_Eng'  # FIXME
...
def main():
    ...
    mlt_train = MLT17Dataset(osp.join(SRC_DATASET_DIR, 'train/images'),
                             osp.join(SRC_DATASET_DIR, 'train/gt'),
                             copy_images_to=dst_image_dir)
    mlt_valid = MLT17Dataset(osp.join(SRC_DATASET_DIR, 'val/images'),
                             osp.join(SRC_DATASET_DIR, 'val/gt'),
                             copy_images_to=dst_image_dir)
